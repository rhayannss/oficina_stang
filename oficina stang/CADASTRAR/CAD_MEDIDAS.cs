...
{
    public partial class CAD_MEDIDAS : Form
    {
        public CAD_MEDIDAS()
        {
            InitializeComponent();
        ...
        private void CAD_MEDIDAS_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("DESEJA CADASTRAR OUTRA UNIDADE?", " ATENÇÃO!!!", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
                {
                    A = 1;
                    medidasBindingSource.AddNew();
                }
        ...
        private void CAD_MEDIDAS_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (A == 1)
            {
                e.Cancel = true;
